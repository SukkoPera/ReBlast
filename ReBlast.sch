...
Wire Wire Line
	7020 7475 7485 7475
Connection ~ 7485 7475
$Comp
L Amplifier_Operational:TLC272 U4
U 1 1 637D1004
P 8345 6980
F 0 "U4" H 8345 7255 50  0000 C CNN
F 1 "TLC272" H 8345 7346 50  0000 C CNN
F 2 "Package_DIP:DIP-8_W7.62mm_Socket" H 8345 6980 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tlc272.pdf" H 8345 6980 50  0001 C CNN
	1    8345 6980
	1    0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 637EEF73
P 7485 7080
F 0 "RV1" H 7416 7126 50  0000 R CNN
F 1 "100K" H 7416 7035 50  0000 R CNN
F 2 "Potentiometer_THT:Potentiometer_ACP_CA14V-15_Vertical" H 7485 7080 50  0001 C CNN
F 3 "~" H 7485 7080 50  0001 C CNN
	1    7485 7080
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 637ED8BA
P 7485 6630
F 0 "R1" H 7555 6676 50  0000 L CNN
F 1 "470k" H 7555 6585 50  0000 L CNN
F 2 "Resistor_THT:R_Axial_DIN0204_L3.6mm_D1.6mm_P7.62mm_Horizontal" V 7415 6630 50  0001 C CNN
F 3 "~" H 7485 6630 50  0001 C CNN
	1    7485 6630
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 637F3978
P 7020 6860
F 0 "C1" H 6906 6906 50  0000 R CNN
F 1 "100n" H 6906 6815 50  0000 R CNN
F 2 "Capacitor_THT:C_Disc_D5.0mm_W2.5mm_P2.50mm" H 7058 6710 50  0001 C CNN
F 3 "~" H 7020 6860 50  0001 C CNN
	1    7020 6860
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 65FFC4C2
P 7485 7555
F 0 "#PWR0128" H 7485 7305 50  0001 C CNN
F 1 "GNDA" H 7490 7382 50  0000 C CNN
F 2 "" H 7485 7555 50  0001 C CNN
F 3 "" H 7485 7555 50  0001 C CNN
	1    7485 7555
	-1   0    0    -1  
$EndComp
$Comp
...
F 1 "100n" H 8319 9895 50  0000 L CNN
...
Text Notes 8590 9065 2    50   ~ 0
R4 IS 10k ON SOME BOARDS,\nWHICH PROBABLY MEANS\nR3 IS 33k ON THOSE...
$Comp
L Device:R R6
U 1 1 66029307
P 8360 6640
F 0 "R6" V 8567 6640 50  0000 C CNN
F 1 "330k" V 8476 6640 50  0000 C CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P2.54mm_Vertical" V 8290 6640 50  0001 C CNN
F 3 "~" H 8360 6640 50  0001 C CNN
	1    8360 6640
	0    1    -1   0   
$EndComp
Wire Wire Line
...
U 1 1 65F29FC9
P 7485 6225
F 0 "#PWR0126" H 7485 6075 50  0001 C CNN
F 1 "+5V" H 7500 6398 50  0000 C CNN
F 2 "" H 7485 6225 50  0001 C CNN
F 3 "" H 7485 6225 50  0001 C CNN
	1    7485 6225
	-1   0    0    -1  
$EndComp
Connection ~ 7485 6295
...
adc_vref_half
Text Label 9475 6980 2    50   ~ 0
adc_vref_half
Text Notes 8500 6580 0    50   ~ 0
APPARENTLY R6 DOESN'T MAKE MUCH SENSE,\nBUT IT MIGHT BE THERE TO COMPENSATE FOR\nTHE INPUT IMPEDANCE?
Wire Wire Line
	3100 8000 2610 8000
...
Text Notes 7825 8610 0    50   ~ 0
INPUT AMPLIFIER\n(Gain = 3.3x)
Text Notes 7820 5735 0    50   ~ 0
FULL SCALE ADJUSTMENT
Text Notes 7680 7665 0    50   ~ 0
WITH THESE RESISTORS, DIVIDER\nOUTPUTS BETWEEN 0 AND 0.877V,\nWHICH DOESN'T MAKE MUCH SENSE...
$Comp
L power:+5V #PWR0131
U 1 1 65EAE98B
P 15760 815
